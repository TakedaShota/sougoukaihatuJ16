            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    <div class="flex space-x-4">
                        ...
                        <a href="{{ route('register.form') }}" class="text-sm text-gray-600 hover:text-gray-900">登録</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{ 'block': open, 'hidden': ! open }" class="hidden sm:hidden">
        @auth
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('dashboard')">ダッシュボード</x-responsive-nav-link>

                    @if(auth()->user()->is_admin)
                        <x-responsive-nav-link :href="route('admin.dashboard')">管理者ページ</x-responsive-nav-link>
                    @endif
        ...
        @else
            <div class="pt-4 pb-1 border-t border-gray-200">
                ...
                <x-responsive-nav-link :href="route('register.form')">登録</x-responsive-nav-link>
            </div>
        @endauth
    </div>
</nav>
