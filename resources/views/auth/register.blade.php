                ...
                <form action="{{ route('register.store') }}" method="POST" class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="name"
                               class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-green-300 focus:bg-white focus:outline-none"
                               placeholder="例：山ちゃん、ひろこ" required>
                    </div>
                    ...
                    {{-- 🔐 4桁暗証番号 --}}
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1 ml-1">
                            暗証番号（ログイン用）
                        </label>
                        <input type="password" name="password" maxlength="4" pattern="\d{4}"
                            class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-100 rounded-2xl
                                    focus:border-green-300 focus:bg-white focus:outline-none transition-all"
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" maxlength="4" pattern="\d{4}"
                            class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-100 rounded-2xl
                                    focus:border-green-300 focus:bg-white focus:outline-none transition-all"
                    ...
                    <button type="submit"
                            class="w-full mt-4 bg-green-500 hover:bg-green-600 text-white font-bold py-4 rounded-2xl shadow-lg shadow-green-100 transition-transform active:scale-95 text-lg">
                        仲間に入る
                    </button>
                </form>

                <div class="mt-8 text-center">
                    <a href="{{ route('login') }}" class="text-gray-500 text-sm hover:text-orange-500">
