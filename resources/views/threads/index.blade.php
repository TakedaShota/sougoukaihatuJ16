...
<div class="max-w-5xl mx-auto p-4 sm:p-8 min-h-screen">
    ...
    <div class="text-center mb-12">
        <h1 class="text-4xl font-extrabold text-orange-600 mb-3 tracking-tighter">趣味の仲間づくり広場</h1>
        <p class="text-gray-600 text-lg">「ひとりより、ふたり。」好きなことを一緒に楽しみませんか？</p>
    </div>
            ...
            <div class="bg-white border-2 border-orange-100 rounded-3xl p-6 shadow-sm hover:shadow-2xl transition-all relative overflow-hidden group">
                ...
                <div class="flex items-center justify-between mt-auto border-t border-gray-50 pt-5">
                    <div class="flex items-center text-sm text-gray-500">
                        <span class="bg-gray-100 p-2 rounded-lg mr-3">🕒 {{ $thread->created_at->diffForHumans() }}</span>
                        <span class="font-bold text-orange-500">
                            💬 {{ $thread->comments_count ?? 0 }}人が関心あり
                        </span>
                    </div>
                    <span class="text-orange-600 font-bold group-hover:translate-x-1 transition-transform">詳しく見る →</span>
                </div>
            </div>
        @empty
            <div class="col-span-full text-center py-20 bg-white rounded-3xl border-4 border-dotted border-gray-100">
                <p class="text-2xl text-gray-400 font-bold">まだ募集がありません。<br>あなたの趣味をみんなに教えてくれませんか？</p>
            </div>
        @endforelse
    </div>
</div>
